...
type Argument interface {
	...
	// the extraFiles map should be fully formed minus the FD to be associated
	// with the file, as it will be appended by createSandboxProcess - ie, a key
	// in the map should look like "--foo-fd="
